...
public final class MWhitelist extends JavaPlugin {
    ...
    private void initPluginUpdateService() {
        ...
        PluginUpdateServiceImpl pluginUpdateService = new PluginUpdateServiceImpl("https://raw.githubusercontent.com/Knabbiii/mWL-Updated/main/docs/mWL.json", destinationPath, destinationName, configRegister.getLangConfig());
